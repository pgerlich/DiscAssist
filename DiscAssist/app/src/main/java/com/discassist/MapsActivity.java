...
public class MapsActivity extends FragmentActivity {
    ...
    private void setUpMap() {
        mMap.addMarker(
                new MarkerOptions().position(new LatLng(41.436326, -90.164149)).title("Richmond Hill Park"));
...
//                .position(new LatLng(41.436326, -90.164149))
//                .title("Richmond Hill Park")
//                .snippet("Some shit dis shit disc golf yoyoyoyo")
